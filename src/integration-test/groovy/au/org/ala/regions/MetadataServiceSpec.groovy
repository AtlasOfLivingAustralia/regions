...
class MetadataServiceSpec extends Specification {
    ...
    void "test species record list url"() {
        ...
        when:
        String url = metadataService.buildSpeciesRecordListUrl(regionFid, regionType, regionName, regionPid, from, to)
    ...
    void "test buildDownloadRecordsUrl"() {
        ...
        String groupName = "Mammals"
        String subgroup = "Diprotodont Marsupials"
//        au.org.ala.regions.binding.DownloadParams downloadParams = new DownloadParams(
